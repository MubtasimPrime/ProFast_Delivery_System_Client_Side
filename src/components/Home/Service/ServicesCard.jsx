...
const ServicesCard = ({ service }) => {
  ...
  return (
    <div
      className="bg-white rounded-3xl p-8 flex flex-col items-center gap-4 shadow-md 
        hover:shadow-xl hover:bg-[#CAEB66] transition-all hover:scale-105 duration-300 "
    >
